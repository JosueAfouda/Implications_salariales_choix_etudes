...
library(factoextra)
library(cluster)
setwd("D:/DATASCIENTIST_LEARNING/DATACAMP.COM/Projetcs/Degrees_That_Pay_You_Back")
...
salary <- read_csv("datasets/degrees-that-pay-back.csv")
str(salary)
...
salary <- read_csv("datasets/degrees-that-pay-back.csv", skip = 1, col_names = c(
